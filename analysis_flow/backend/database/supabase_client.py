...
# vector search, and admin operations.
...
class SupabaseClient :
    ...
    def vector_search (
        ...
        Args:
            ...
            source_filter: Optional filter by source_type (pubmed, textbook, guideline)
    ...
    source_type :str ="textbook"
        ...
        Args:
            ...
            source_type: Origin of content (pubmed, textbook, guideline)
        Returns:
